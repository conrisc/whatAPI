...
(function(factory) {
  if (typeof define === 'function' && define.amd && false) {
    ...
    define(['ApiClient', 'model/NoteItem', 'api/AdminsApi', 'api/DevelopersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/NoteItem'), require('./api/AdminsApi'), require('./api/DevelopersApi'));
  }
}(function(ApiClient, NoteItem, AdminsApi, DevelopersApi) {
  'use strict';
